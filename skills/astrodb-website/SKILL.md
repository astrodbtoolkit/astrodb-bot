...
doesn't exist yet). Record: the website repo URL used, which database was connected, the
primary table and coordinate columns detected, and any troubleshooting steps taken.
