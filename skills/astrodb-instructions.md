...
instructions file — `astrodb-build-instructions.md`, `astrodb-ingest-instructions.md`, or
`astrodb-website-instructions.md` (symlinked into each skill as `references/astrodb-<phase>-instructions.md`):
...
phase's `astrodb-<phase>-instructions.md`.** Use this standard entry format:
...
**Kind:** gotcha | one-off
**Where:** <skill and step, or script path — e.g. astrodb-build-02-parse-table Step 3>
...
`astrodb-<phase>-instructions.md`. Some phases track it in a file because they span many skills; others
