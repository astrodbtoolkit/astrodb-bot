...
### 6a: Ask for the database description
...
- [ ] **Artifacts** — `astrodb-build-artifacts/` exists. It contains `directions.md` only if the user actually wrote one; you did not leave an unfilled template behind.
