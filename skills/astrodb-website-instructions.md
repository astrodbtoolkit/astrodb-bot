# AstroDB Website Instructions: conventions for the website workflow

These refine the shared conventions in `astrodb-instructions.md` for the **website** skill
(`astrodb-website`). Read `astrodb-instructions.md` first — it covers the artifact folder, the
...
- **Append** one entry (using the standard entry format from `astrodb-instructions.md`, newest at the
